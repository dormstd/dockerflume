...
RUN mkdir -p /opt/flume-config && apk add --update bash && apk add tar && rm -rf /var/cache/apk/*
RUN wget -qO- http://archive.apache.org/dist/flume/1.8.0/apache-flume-1.8.0-bin.tar.gz \
